...
public class MovieDiaryRunner
{
	...
	Object[] options = {"Log a film", "View Logs", "Quit"};
        int n = JOptionPane.showOptionDialog(null,"What would you like to do?", "Movie Diary Runner", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null, options,options[2]);
